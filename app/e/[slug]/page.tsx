      ...
      <div className="max-w-7xl mx-auto px-6 py-8 lg:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col space-y-8">
            ...
            <div className="relative w-full aspect-[4/3] rounded-[2rem] overflow-hidden bg-[var(--surface-container-low)] group">
              ...
              <div className="absolute bottom-8 left-8 right-8">
                <span className="inline-block px-4 py-1.5 rounded-full bg-[var(--secondary-container)] text-[var(--on-secondary-container)] font-label text-xs uppercase tracking-[0.15em] mb-4">
                  Event Registration
                </span>
                <h1 className="text-white text-4xl md:text-5xl font-headline font-extrabold tracking-tight leading-[0.95]">
                  {event.title}
                </h1>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Date & Time Card */}
              <div className="p-6 md:p-8 rounded-[1.5rem] bg-[var(--surface-container-low)] flex flex-col justify-between min-h-[180px] border border-[var(--outline-variant)]/10">
                <div className="w-12 h-12 rounded-xl bg-[var(--primary-container)]/30 flex items-center justify-center mb-4">
                ...
                <div>
                  ...
                  <h3 className="text-lg md:text-xl font-headline font-bold text-[var(--on-surface)]">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-8">
            <div className="bg-[var(--surface-container-lowest)] p-6 md:p-10 rounded-[2rem] shadow-[0_12px_40px_rgba(74,69,75,0.06)] border border-[var(--outline-variant)]/15">
              <h2 className="text-2xl font-headline font-extrabold text-[var(--on-surface)] mb-2 tracking-tight">
                Register for Event
              </h2>
              <p className="text-[var(--on-surface-variant)] mb-8 font-body">
            ...
            {/* Info Card */}
            <div className="mt-6 p-5 rounded-[1.25rem] bg-[var(--secondary-container)]/30 border border-[var(--secondary-container)] flex gap-4 items-start">
              <div className="w-10 h-10 rounded-xl bg-[var(--secondary-container)] flex items-center justify-center shrink-0">
                <svg className="w-5 h-5 text-[var(--on-secondary-container)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <div>
                <h4 className="font-headline font-bold text-[var(--on-secondary-container)]">What&apos;s Included</h4>
                <p className="text-sm text-[var(--on-secondary-container)] opacity-80 leading-snug mt-1">
